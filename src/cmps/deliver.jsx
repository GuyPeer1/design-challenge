export function Deliver() {
    ...
    return (<section className="deliver">
        ...
        <div className="persons">
            ...
            <div className="person">“Amazing. Our team helped us build an app that delivered a new experience for hiring a physio. The launch was an instant success with 100k downloads in the first month.”
